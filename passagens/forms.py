...
from passagens.models import Passagem, classe_viagem, Pessoa
...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        model = Passagem
        fields = '__all__'
        labels = {'data_ida':'Data de ida', 'data_volta': 'Data de volta', 'informacoes': 'Informações', 'classe_viagem': 'Classe do voô'}
        widgets = {
            'data_ida': DatePicker(),
